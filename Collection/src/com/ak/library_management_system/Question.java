...
/*Create a Library Management project by using Collection Framework Concept to perform 
  different types of Library Management System like add book, update quantity, delete 
  book and search a book from library.
...
Return Type        : void
Access modifier    : public
In this method update the quantity the Book, In order to update the quantity, 
first verify ISBN number by using private Helper method and then update the 
quantity by using setter method.
