...
Assignment : Q2
-----------------
Use Stream.iterate or Stream.generate to create an infinite stream then filter and map
 the data to produce the first 10 odd squares.
...
WAP to find out top passing students name in an OCPJP exam where the passing score of exam is 65%.
