...
Assignment01:
============
You are tasked with developing a Java application that interacts with a relational database using JDBC.
 The application needs to perform a series of database operations within a single transaction. 
 Your task is to design and implement a Java program that accomplishes the following:
...
Assignment2:Write a jdbc program as follows:
