...
/*
 Create a Scenario based program on Course Registration System using HashMap where 
 multiple students can be added in a particular course.
[See the Test cases].
...
In this main method create one HashMap object which takes Course name(String) as a key and 
Students name (List<String>) as a value.

Create Scanner class object to perform various operation on CourseRegistration system by 
using switch case.
