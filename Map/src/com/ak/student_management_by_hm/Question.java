...
/*
 Create a Scenario based program on Student Management System using HashMap where we need to 
 Add Student, Update Marks, Delete Student, Search Student, Display All Students,
  Show Lowest Scorer, Show Total and Average Marks.

Coding Requirements :
---------------------
Take an ELC class StudentDataManagement with main method.

In this main method create one HashMap object which takes Student name as a key and Student marks 
as a value.
